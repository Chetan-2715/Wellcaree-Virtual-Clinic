    ...
    <div className="min-h-screen pb-20 pt-10">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-clinic-950 mb-4">Book Your Consultation</h1>
            ...
            <React.Fragment key={i}>
              <div className="flex flex-col items-center space-y-2">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all ${
                  step >= item.s ? 'bg-clinic-600 text-white shadow-lg' : 'bg-gray-100 text-gray-400'
                }`}>
                  <item.icon size={20} />
                </div>
                <span className={`text-xs font-bold uppercase tracking-widest ${
                  step >= item.s ? 'text-clinic-900' : 'text-gray-400'
                }`}>{item.label}</span>
              </div>
              {i < 2 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full px-6 py-4 rounded-xl bg-gray-50 outline-none focus:ring-2 focus:ring-clinic-500 transition-all" />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="email" className="w-full px-6 py-4 rounded-xl bg-gray-50 outline-none focus:ring-2 focus:ring-clinic-500 transition-all" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-500">Phone (WhatsApp preferred)</label>
                    <input type="tel" className="w-full px-6 py-4 rounded-xl bg-gray-50 outline-none focus:ring-2 focus:ring-clinic-500 transition-all" />
                  </div>
                </div>
                <div className="flex justify-end">
                  <button onClick={nextStep} className="bg-clinic-600 text-white px-10 py-4 rounded-xl font-bold flex items-center space-x-2">
                    <span>Next Step</span>
                    <ArrowRight size={20} />
                  </button>
                </div>
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <textarea rows={4} placeholder="Describe your main symptoms..." className="w-full px-6 py-4 rounded-xl bg-gray-50 outline-none focus:ring-2 focus:ring-clinic-500 transition-all resize-none"></textarea>
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-500">Duration of Complaint</label>
                    <select className="w-full px-6 py-4 rounded-xl bg-gray-50 outline-none focus:ring-2 focus:ring-clinic-500 transition-all">
                ...
                <div className="flex justify-between">
                  <button onClick={prevStep} className="text-gray-500 px-10 py-4 font-bold flex items-center space-x-2 hover:text-clinic-600">
                    <ArrowLeft size={20} />
                    <span>Back</span>
                  </button>
                  <button onClick={nextStep} className="bg-clinic-600 text-white px-10 py-4 rounded-xl font-bold flex items-center space-x-2">
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <label className="cursor-pointer">
                        <input type="radio" name="mode" className="hidden peer" />
                ...
                <div className="flex justify-between">
                  ...
                  <button onClick={handleSubmit} className="bg-clinic-600 text-white px-10 py-4 rounded-xl font-bold flex items-center space-x-2 shadow-xl shadow-clinic-100">
